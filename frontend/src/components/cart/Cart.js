...
export default function Cart() {
    ...
    const count = item.quantity;
        ...
        console.log(count,'incrementqty')

        if(item.stock == 0  ||  count >= item.stock) return; //item stact is with in the count of product available
    ...
    return (
       ...
       {/* using the map method we showing the item products  */}
                                        ...
                                        <div className="row">
                                            <div className="col-4 col-lg-3">
                                                ...
                                                <img src={item.image} alt={item.name} height="90" width="115"/>
                                                                          ...
                                                                          {/*showing the item detail from the cart page  */}
